...
var modals = function modals() {
  ...
  function bindModal(triggerClass, modalClass, closeClass) {
    ...
    var trigger = document.querySelectorAll(triggerClass),
  ...
  function modalShowUpOnTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px");
        var right = getComputedStyle(document.querySelector('.fixed-gift')).right;
        right = Number(right.slice(0, -2)) + Number(scroll);
        document.querySelector('.fixed-gift').style.right = "".concat(right, "px");
      }
    }, time);
  }
